...
class ChangePasswordDialog extends Dialog
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    private TextField additionalFactorTextField_;  // Text field for additional factor
    ...
    ChangePasswordDialog(Frame parent, String titleText, boolean showshowAdditionalFactorFactor)
    {
        ...
        // Create group label that will contain old and new passwords
        ...
        // Create the old password label and field
        ...
        // Create the new password label and field
        ...
        // Create the authentication factor label/field.
        if (showshowAdditionalFactorFactor)
        {
            label = new Label(ResourceBundleLoader.getText("DLG_ADDITIONAL_FACTOR_LABEL"), Label.LEFT);
            add(this, label, constraints, 0, 6, 1, 1);
            ...
            add(this, additionalFactorTextField_, constraints, 1, 6, 1, 1);
        }
        ...
        add(this, centeringPanel_, constraints, 0, showshowAdditionalFactorFactor ? 7 : 6, 2, 1);
    ...
    public void paint(Graphics gc)
    {
        ...
        int bottom = (additionalFactorTextField_ == null) 
                ? (centeringPanel_.getBounds().y + confirmTextField_.getBounds().y + confirmTextField_.getBounds().height) / 2
                : (additionalFactorTextField_.getBounds().y + confirmTextField_.getBounds().y + confirmTextField_.getBounds().height) / 2;
    ...
    // This method returns the additional factor.
    // @return  The factor.
    String getAdditionalFactor()
    {
