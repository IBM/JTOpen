...
//                              });
    ...
    public boolean isThreadUsed() {
        return properties_.isThreadUsed();
    } 
     ...
     *  @param reduced true if need to check current number of connections; false otherwise.
     **/
    ...
    public void setRunMaintenance(boolean cleanup)
    {
        ...
        if (changes_ != null) 
            changes_.firePropertyChange(property, Boolean.valueOf(oldValue), Boolean.valueOf(cleanup));
  
        // We don't care if maintenance is currently running or not,
    ...
    public void setThreadUsed(boolean useThreads) {
        properties_.setThreadUsed(useThreads, isInUse());
    }
