...
//@A2D        return actualConnection_.createStatement (resultSetType, resultSetConcurrency, resultSetHoldability);
    try
    {
      ...
      return(Statement)m.invoke(actualConnection_, new Object[] { Integer.valueOf(resultSetType), Integer.valueOf(resultSetConcurrency), Integer.valueOf(resultSetHoldability)}); //@A2A
    }
...
//@A2D        return actualConnection_.prepareCall (sql, resultSetType, resultSetConcurrency, resultSetHoldability);
    try
    {
      ...
      return(CallableStatement)m.invoke(actualConnection_, new Object[] { sql, Integer.valueOf(resultSetType), Integer.valueOf(resultSetConcurrency), Integer.valueOf(resultSetHoldability)}); //@A2A
    }
    catch (NoSuchMethodException nsme) //@A2A
    {
    }
...
//@A2D        return actualConnection_.prepareStatement (sql, autoGeneratedKeys);
    try
    {
      ...
      return(PreparedStatement)m.invoke(actualConnection_, new Object[] { sql, Integer.valueOf(autoGeneratedKeys)}); //@A2A
    }
    catch (NoSuchMethodException nsme) //@A2A
    {
    }
...
//@A2D        return actualConnection_.prepareStatement (sql, resultSetType, resultSetConcurrency, resultSetHoldability);
    try
    {
      ...
      return(PreparedStatement)m.invoke(actualConnection_, new Object[] { sql, Integer.valueOf(resultSetType), Integer.valueOf(resultSetConcurrency), Integer.valueOf(resultSetHoldability)}); //@A2A
    }
    catch (NoSuchMethodException nsme) //@A2A
    {
    }
...
//@A2D        actualConnection_.setHoldability (holdability);
    try
    {
      ...
      m.invoke(actualConnection_, new Object[] { Integer.valueOf(holdability)}); //@A2A
    }
    catch (NoSuchMethodException nsme) //@A2A
    {
    }
