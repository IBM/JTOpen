...
/**
 * Represents an integrated file system file descriptor. Instances of the file descriptor class serve as an opaque
 * handle to the underlying structure representing an open file or an open socket. Applications should not create their
 * own file descriptors.<br>
 ...
 **/
public final class IFSFileDescriptor implements java.io.Serializable
{
  ...
  void chooseImpl ()
  {
      ...
      impl_ = (IFSFileDescriptorImpl) system_.loadImpl2("com.ibm.as400.access.IFSFileDescriptorImplRemote",
      ...
      impl_.initialize(fileOffset_, parentImpl, path_, shareOption_, system_.getImpl());
  }
