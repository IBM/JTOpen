...
public abstract class AS400Server
{
    ...
    static final int getServerId(String serviceName)
    {
        ...
        if ("as-hostcnn-s".equals(serviceName)) return AS400.CONNECTION;
    ...
    static final int getServerId(int service)
    {
        switch (service)
        {
            ...
            case AS400.CONNECTION: return 0xE00B;
            case AS400.CONNECTION2: return 0xE00B;
        }
    ...
    static int getServiceId(String serviceName)
    {
        ...
        if (serviceName.equals("as-hostcnn-s")) return AS400.CONNECTION;
