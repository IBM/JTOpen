...
public interface Copyright
{
    ...
    static final int    MINOR_VERSION = 4; // ex: "1" indicates PTF #1 (1 is first PTF in a release)
                                           //Note: JTOpen 21.0.7 is syncing with ptf 14.4
    static final String DRIVER_LEVEL  = "07060004"; //(ex: 07060001 -> V7R6M0 PTF#1) (needed for hidden clientInfo) (each # is 2 digits in length)
