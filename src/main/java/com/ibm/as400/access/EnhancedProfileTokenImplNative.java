...
public class EnhancedProfileTokenImplNative 
{
  ...
  static
  {
	 ...
	 *                                    token.
	 */
	   public static native byte[] nativeCreateToken(String user, 
    			char[] password, 
		 ...
		 *                                    token.
		 */
		   public static native byte[] nativeCreateTokenSpecialPassword(String user, 
	    			char[] password, 
	    			char[] additionalAuthenticationFactor,
	 ...
	 */
    public static native void nativeSwap(byte[] token,
		    String verificationId,
