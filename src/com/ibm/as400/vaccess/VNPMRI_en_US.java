...
//
// We extend VMPMRI rather than VNPMRI_en to circumvent the loading
// of the VNPMRI_en class, which does not contain anything, anyway.
//
public class VNPMRI_en_US extends VNPMRI
{
