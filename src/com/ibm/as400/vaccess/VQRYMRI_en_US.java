...
//
// We extend VQRYMRI rather than VQRYDMRI_en to circumvent the loading
// of the VQRYMRI_en class, which does not contain anything, anyway.
//
public class VQRYMRI_en_US extends VQRYMRI
{
