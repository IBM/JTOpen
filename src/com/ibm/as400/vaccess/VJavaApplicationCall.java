 ...
 *
 *<P>
 *GUI output generated by the Java program running on the server
 *is not handled by this class.
 *As in JavaApplicationCall, the Java program running on the server
 ...
 *
 *<P>
 *There are two ways to set up the server Java environment:
 *<OL>
                                   ...
                                   implements KeyListener
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    **/
    ...
    /**
     * Loads information produced by the Java Application run on the server.
    **/
    private void load()
    {
