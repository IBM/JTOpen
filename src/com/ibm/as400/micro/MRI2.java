...
//     D97445   v4r5m0  03/01/1999 cnock    Moved resourced from MRI class.
// $A3A         v4r4    09/04/1998 Baoning  Added System Pool mri.
//              v4r5m0  04/09/1999 wiedich  Added SystemStatus & SystemPool MRI
// $A4=         v4r5m0  05/04/1999 cnock    Moved core MRI into CoreMRI.
// $D1=D97449   v4r5m0  05/17/1999 daw      Added beaninfo MRI for JavaAppplicationCall
// $C2          v4r5    05/24/99   wyd      Added product license properties.
// $D2=P9900745 v4r5m0  07/01/1999 cnock    Flag values with no options.
// $D3=P9900745 v4r5m0  07/01/1999 cnock    Add shortcuts to usage.
// $D4=P9900745 v4r5m0  07/01/1999 cnock    Report and handle down peers.
// $A1=P9901503 v4r5m0  07/14/1999 daw      Message File Bean MRI.
// $E1=D98010   v5r1m0  10/22/1999 cnock    Deleted JobList MRI.
// $E2=P9909210 v5r1m0  11/09/1999 cnock    Added colon.
// $E3=P9909198 v5r1m0  11/10/1999 buhr     Added ConnectionPool MRI.
// $E4=D98003   v5r1m0  11/10/1999 jlee     Added thread-safe MRI.
// $E5=P9911579 v5r1m0  12/15/1999 buhr     Added ConnectionPool MRI.
// $E6=P9912056 v5r1m0  12/30/1999 funks    Added AS400ConnectionPool MRI.
// $E7=P9912794 v5r1    01/14/2000 wiedrich Added AS400JPing MRI.
// $E8=P9914967 v5r1m0  02/07/2000 funks    Added AS400ConnectionPool MRI.
// $E9=P9924224 v5r1m0  04/28/2000 wiedrich Added additional Proxy SSL MRI.
// $F1=P9924671 v5r1m0  05/11/2000 funks    Added AS400JDBCDataSource MRI.
// $F2=P9926977 v5r1m0  06/21/2000 funks    Added new exception MRI.
// $F3=         v5r1m0  08/01/2000 cnock    Moved MRI for object types from MRI.java.
// $F4=P9929908 v5r1m0  08/11/2000 jlee     Added NetServer MRI.
// $F5=         v5r1m0  08/14/2000 glidden  License component MRI.
//  D1=P9931486 v5r1m0  08/25/2000 daw      System name change
//  D9=P        v5r1m0  09/07/2000 daw      Job number
// $F6=P9933122 v5r1m0  09/18/2000 cnock    Object type/subtype corrections.
// $F7=P9933710 v5r1m0  10/02/2000 glidden  Update for Product License beans.
// $M1=D98585   v5r2m0  05/07/2001 wiedrich Added ToolboxME MRI.
//
// END CHANGE ACTIVITY
//
////////////////////////////////////////////////////////////////////////////
