...
public final class AuthenticationKeyPair {
  ...
  AuthenticationKeyPair(java.security.KeyPair keyPair, Eid appEimID, String appInstanceID, long lifeSpan, int keySize)
  {
  ...
  void setInnerKeyPair(java.security.KeyPair keyPair) {
    ...
    // Note: We call the encapsulated KeyPair the "inner" KeyPair to differentiate it from the enclosing "outer" AuthenticationKeyPair.
    innerKeyPair_ = keyPair;
  }
