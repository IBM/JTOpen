...
public interface Constants
{
   ...
   **/
  public static final int ATKNERR_TKN_APP_INST_MISMATCH = 11;

  /**
   EimException return code, indicating "Token signature is not valid.  Token may have been modified."
   **/
  public static final int ATKNERR_SIGNATURE_INVALID = 12;

  /**
   EimException return code, indicating "Authentication token is not valid."
   **/
  public static final int ATKNERR_TKN_INVALID = 13;

  /**
   EimException return code, indicating "Target user not found for authentication token."
   **/
  public static final int ATKNERR_TARGET_USER_NOT_FOUND = 14;

  /**
   EimException return code, indicating "EIM identifier not found."
   **/
  public static final int ATKNERR_EIMID_NOT_FOUND = 15;

  // Note: The C version defines ATKNERR_KEYHANDLE_INVALID = 16.
   ...
   **/
  public static final int ATKNERR_TKN_VERSION_NOT_SUPPORTED = 17;

  /**
   EimException return code, indicating "Public key was not found, so unable to check signature."
   **/
  public static final int ATKNERR_PUBLIC_KEY_NOT_FOUND = 18;
  ...
  static final int CCSID = 1200;  // CCSID for CHAR(*) fields in auth tokens
