...
/**
 ...
 This class is instantiated by {@link AuthenticationDomain#getApplicationInfo(String,int) getApplicationInfo}.
<p><b>Usage Notes</b>
...
concatenating the ATKN_ESERVERID value (__IBM_DEFINED__:eServerID=)
...
If {@link AuthenticationDomain#getApplicationInfo(String,int) getApplicationInfo} doesn't find the application instance identifier, it sets the ApplicationInstanceID field to <tt>null</tt>.
</p>
 **/
