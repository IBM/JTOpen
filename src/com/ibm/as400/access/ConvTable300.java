...
// Table for CCSID 300
class ConvTable300 extends ConvTableRedundant
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    private final static int ccsid = 300;
    private ConvTable table;

    ConvTable300()
    {
	// CCSID 300 is the DBCS portion of the mixed byte CCSID 930
	super();
	if (ConvTable.convDebug) Trace.log(Trace.CONVERSION, "Constructing Conversion Table for CCSID: 300 (using CCSID 930)");
    }
	...
	{
	    Trace.log(Trace.CONVERSION, "Converting byte to char for CCSID: 300 (will use CCSID 930)", source, offset, length);
	}
	...
	if (ConvTable.convDebug)
	{
	    Trace.log(Trace.CONVERSION, "Char to byte output (for CCSID 300): ", dest);
	}
	return dest;
    }
}
