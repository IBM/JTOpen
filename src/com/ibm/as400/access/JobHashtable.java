...
/**
 * This class represents a hashtable that uses primitive ints for both keys and 
 * regular Objects for values. It is used primarily in the Job and JobList classes,
 * but is general-purpose and can be used elsewhere if desired.
 ...
 * A valid value is any Object, including null.
