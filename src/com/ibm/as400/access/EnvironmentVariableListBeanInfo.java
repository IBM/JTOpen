...
/**
The EnvironmentVariableListBeanInfo class represents the bean information
for the EnvironmentVariableList class.
**/
public class EnvironmentVariableListBeanInfo 
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private static final Class                  beanClass_              = EnvironmentVariableList.class;
    ...
    public Image getIcon(int icon)
    {
        switch(icon)
        {
            ...
            case ICON_COLOR_16x16:
                if (icon16_ == null)
                    icon16_ = loadImage("EnvironmentVariableList16.gif");
                return icon16_;

            case ICON_MONO_32x32:
            case ICON_COLOR_32x32:
                if (icon32_ == null)
                    icon32_ = loadImage("EnvironmentVariableList32.gif");
                return icon32_;
