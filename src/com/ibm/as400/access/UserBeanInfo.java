...
/**
The UserBeanInfo class represents the bean information
for the User class.
**/
...
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private static final Class                  beanClass_              = User.class;
...
**/
    static
    {
        try
        {
            ...
            propertyDescriptors_ = new PropertyDescriptor[] { system, name };
    ...
    public Image getIcon(int icon)
    {
        switch(icon)
        {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                if (icon16_ == null)
                    icon16_ = loadImage("User16.gif");
                return icon16_;

            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                if (icon32_ == null)
                    icon32_ = loadImage("User32.gif");
                return icon32_;
