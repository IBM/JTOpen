...
implements java.sql.Driver
{
  private static final String copyright = "Copyright (C) 1997-2001 International Business Machines Corporation and others.";
    ...
    static final String DRIVER_LEVEL_           = "06010005"; //(ex: 05040102->V5R4M1.2) (needed for hidden clientInfo) (each # is 2 digits in length), should match version in Copyright.java  //@PDA 550 @jt61 @jt63
