  ...
  private static final String copyright = "Copyright (C) 1997-2002 International Business Machines Corporation and others.";
    ...
    **/
    ...
    throws SQLException
    {
        ...
        if(getVRM() >= JDUtilities.vrm550 && autoGeneratedKeys==Statement.RETURN_GENERATED_KEYS)    //@GKA added new generated key support
        {
    ...
    **/
    ...
    throws SQLException
    {
        if(getVRM() >= JDUtilities.vrm550)   //@GKA added support for generated keys
        {
            // Validation
            checkOpen();
    ...
    **/
    ...
    throws SQLException
    {
        if(getVRM() >= JDUtilities.vrm550)  //@GKA added generated key support
        {
            //Validation
            checkOpen();
