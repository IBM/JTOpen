...
implements Connection
{
  private static final String copyright = "Copyright (C) 1997-2001 International Business Machines Corporation and others.";
    ...
    **/
    ...
    //@G4A JDBC 3.0
    /**
    Returns the current holdability of ResultSets created using this Connection object.
    ...
    **/
    ...
    <p>Full functionality of this method requires support in the release of OS/400 after V5R1,  
    or later.  If connecting to a V5R1 or earlier version of OS/400, the value for 
    autoGeneratedKeys will be ignored.
    ...
    **/
    ...
    //@G4A JDBC 3.0
    /**
    Sets the holdability of ResultSets created using this Connection object.
    
    <p>Full functionality of this method requires support in the release of OS/400 after V5R1,  
    or later.  If connecting to a V5R1 or earlier version of OS/400, the value for 
    holdability will be ignored.
    ...
    throws SQLException
    {
        try
        {
            ...
            try
            {
                ...
                // only to post v5r1 system because they have the server fix needed 
