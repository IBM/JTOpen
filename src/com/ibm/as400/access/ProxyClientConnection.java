...
/**
The ProxyClientConnection class represents the connection 
to a proxy server.  This acts as the interface between
proxy implementation classes in each Toolbox component 
and the proxy datastream classes.
**/
//
// Implementation notes:
//
// 1.  We used to keep a PxTable on the client side to
//     keep track of the objects we created.  The problem
//     is that the table keeps a reference to every object,
//     which prevents them from being garbage collected.
//     This is certainly a memory leak on the client, but
//     since the objects never get finalized, their 
// 
//
...
@param secure               true for a Secure Sockets Layer (SSL) connection;
                            false otherwise.
**/
    public ProxyClientConnection (String proxyServer, boolean secure)
    {               
...
**/
    ...
    {
        // If this is the first listener of its kind, then add a listener
        // down on the proxy server, so that events get reported back.
...
/**
Calls a constructor on the proxy server.  The constructor creates
an object on the proxy server.
...
**/
    public long callConstructor (String className)
...
@exception InvocationTargetException  If the constructor throws an exception.
**/
    public long callConstructor (String className, boolean flag)
        throws InvocationTargetException
    {
...
@return                 The proxy object representing the created object,
                        or null if no object was returned.

@exception InvocationTargetException  If the method throws an exception.
**/
    public ProxyFactoryImpl callFactoryMethod (long proxyId, 
                                               String methodName,
                                               ProxyFactoryImpl proxyImpl)
        throws InvocationTargetException
    {
...
**/
    public ProxyFactoryImpl callFactoryMethod (long proxyId, 
        ...
        throws InvocationTargetException
    {
        PxMethodReqCV request = new PxMethodReqCV (proxyId, 
                                                   methodName, 
                                                   argumentClasses, 
                                                   arguments,
                                                   null,
...
/**
Calls a finalize method on the proxy server.  The object will
be garbage collected on the proxy server.

@param proxyId      The proxy id.

@exception InvocationTargetException  If the finalize method 
                                      throws an exception.
**/
    public void callFinalize (long proxyId)
        throws InvocationTargetException
    {
        // This may have already been called (by this object's finalize()
        // or the ProxyImpl's finalize).  Account for that fact, so
...
@exception InvocationTargetException  If the method throws an exception.
**/
    public ProxyReturnValue callMethod (long proxyId, String methodName)
        throws InvocationTargetException
    {
...
@exception InvocationTargetException  If the method throws an exception.
**/
    public ProxyReturnValue callMethod (long proxyId, 
                                        String methodName,
                                        Class[] argumentClasses,
                                        Object[] arguments)
        throws InvocationTargetException
...
@exception InvocationTargetException  If the method throws an exception.
**/
    public boolean callMethodReturnsBoolean (long proxyId, String methodName)
        throws InvocationTargetException
    {
...
@exception InvocationTargetException  If the method throws an exception.
**/
    public int callMethodReturnsInt (long proxyId, String methodName)
        throws InvocationTargetException
    {
...
@exception InvocationTargetException  If the method throws an exception.
**/
    public Object callMethodReturnsObject (long proxyId, String methodName)
        throws InvocationTargetException
    {
...
**/
    public void connect ()
    {    
        PxConnectReqCV request = new PxConnectReqCV (ProxyConstants.CURRENT_MOD, connectAttempts_++, locale_);
        try {
    ...
    protected void finalize()
        throws Throwable
    {
        // We should tell all of our proxy objects to finalize themselves
...
**/
    ...
    {
        // If this is the last listener of its kind, then remove the listener
        // down on the proxy server, so that events no longer get reported back.
...
/**
Rethrows exceptions returned as InvocationTargetExceptions.  This
provides some common exception handling.
...
// * Throws IOException.
//
    public static InternalErrorException rethrow1 (InvocationTargetException e)
        throws IOException
    {
        Throwable e2 = e.getTargetException ();
...
//
    public static InternalErrorException rethrow2 (InvocationTargetException e)
...
//
    public static InternalErrorException rethrow3 (InvocationTargetException e)
...
//
    public static InternalErrorException rethrow4 (InvocationTargetException e)
...
//
    public static InternalErrorException rethrow4a (InvocationTargetException e)
...
//
    public static InternalErrorException rethrow5 (InvocationTargetException e)
        throws AS400SecurityException, ErrorCompletingRequestException,
...
//
    public static InternalErrorException rethrow6 (InvocationTargetException e)
        throws AS400SecurityException, ErrorCompletingRequestException,
        InterruptedException, IOException, ObjectDoesNotExistException,
...
//
    public static InternalErrorException rethrow6a (InvocationTargetException e)
