...
/**
   <p>The AS400CertificateUsrPrfUtilImpl provides the base class for the implementation of the methods for accessing certificates in an i5/OS user profile object.  
**/
