...
//@M8    20141111  JDBC:  Fix DRDA correlation id issue
...
public interface Copyright
{
    ...
    public static String version   = "Open Source Software, JTOpen 8.4, codebase 5770-SS1 V7R2M0.00 built=20141111 @M8";  

    // Constants for reference by AS400JDBCDriver.
    static final int    MAJOR_VERSION = 10; // ex: "10" indicates V7R2, while "9" indicates V7R1
    static final int    MINOR_VERSION = 4; // ex: "4" indicates PTF #4 (1 is first PTF in a release)
                                           //Note: JTOpen 8.4 is synching with ptf 10.4
    static final String DRIVER_LEVEL  = "07020004"; //(ex: 07020004 -> V7R2M0 PTF#4) (needed for hidden clientInfo) (each # is 2 digits in length)
