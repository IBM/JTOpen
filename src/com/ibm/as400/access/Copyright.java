...
public interface Copyright
{
    ...
    public static String copyright = "Copyright (C) 1997-2010 International Business Machines Corporation and others.";
    public static String version   = "Open Source Software, JTOpen 7.2, codebase 5770-SS1 V7R1M0.03 2010/12/15 @B4";  // As of V7R1: JC1 is merged into SS1 Option 3
