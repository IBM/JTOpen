...
public interface Copyright
{
    ...
    public static String version   = "Open Source Software, JTOpen 8.7, codebase 5770-SS1 V7R2M0.00 built=20160121 @Q3";  

    // Constants for reference by AS400JDBCDriver.
    static final int    MAJOR_VERSION = 10; // ex: "10" indicates V7R2, while "9" indicates V7R1
    static final int    MINOR_VERSION = 7; // ex: "7" indicates PTF #7 (1 is first PTF in a release)
                                           //Note: JTOpen 8.7 is synching with ptf 10.7
    static final String DRIVER_LEVEL  = "07020007"; //(ex: 07020007 -> V7R2M0 PTF#7) (needed for hidden clientInfo) (each # is 2 digits in length)
