...
public interface Copyright
{
    ...
    //                                                                                         built=20180530 is automatically set by the build (see build.xml)
    public static String version   = "Open Source Software, JTOpen 9.5, codebase 5770-SS1 V7R3M0.00 built=20180605 @W6";  
    ...
    static final String DRIVER_LEVEL  = "07030005"; //(ex: 07030007 -> V7R3M0 PTF#7) (needed for hidden clientInfo) (each # is 2 digits in length)
