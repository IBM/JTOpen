...
public interface Copyright
{
    ...
    static final int    MINOR_VERSION = 5; // ex: "5" indicates PTF #5 (1 is first PTF in a release)
                                           //Note: JTOpen 8.5 is synching with ptf 10.5
    static final String DRIVER_LEVEL  = "07020005"; //(ex: 07020005 -> V7R2M0 PTF#5) (needed for hidden clientInfo) (each # is 2 digits in length)
