...
public interface Copyright
{
    ...
    //                                                                                              built=XXXXXXX is automatically set by the build (see build.xml)
    public static String version   = "Open Source Software, JTOpen 7.7, codebase 5770-SS1 V7R1M0.07 built=20120228 @FB";  // As of V7R1: JC1 is merged into SS1 Option 3
