...
public class AS400JDBCRowSet extends Object implements RowSet, Serializable             // @A3C
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
   ...
   private ResultSet resultSet_;               // The result set.
   ...
   **/
   private void connect() throws SQLException
   {
      ...
      else                          // Use the url to make the connection.
      {
         if (JDTrace.isTraceOn ())
   ...
   **/
   public void execute() throws SQLException
   {
      ...
      {
         resultSet_ = (ResultSet)statement_.executeQuery();
...
**/
   ...
   *  @param dataSourceName The AS/400 data source name.
   **/
   ...
   *
   *  Note: Distinct types are supported by DB2 for OS/400, but are not externalized by the AS/400 Toolbox for Java JDBC driver. In other words, distinct types
   *  behave as if they are the underlying type. Structured types are not supported by DB2 for OS/400. Consequently, this driver does not support the type map.
   *
