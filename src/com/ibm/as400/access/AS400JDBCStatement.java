...
import java.math.BigDecimal;   //@F6A
...
implements Statement
{
  ...
  or later.  If connecting to a V5R1 or earlier version of OS/400, an exception 
  will be thrown.
  ...
  @exception      SQLException    If the statement is not open,
                                ...
                                not a valid value, if connecting to a V5R1 
                                or earlier version of OS/400, or an error occurs.
  ...
  **/
    ...
    **/
    ...
    <p>This method requires OS/400 V5R2 or later.  If connecting to a V5R1 or earlier 
    version of OS/400, an exception will be thrown. 
    ...
    **/
    ...
    throws SQLException
    {
        ...
        else
        {
            ...
            rowCache = new JDSimpleRowCache (formatRow, data, nulls);
        }
