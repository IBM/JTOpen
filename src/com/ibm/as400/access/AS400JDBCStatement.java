...
public class AS400JDBCStatement implements Statement
{
            ...
            try
            {
                ...
                try
                {
                    ...
                    if(openNeeded)
                    {
                        ...
                        if((autoGeneratedKeys_ == RETURN_GENERATED_KEYS) && connection_.getVRM() >= JDUtilities.vrm550) //@GKA Wrapped INSERT WITH SELECT for generated keys.  Result set should be read only, insensitive
                    ...
                    else if ((autoGeneratedKeys_ == RETURN_GENERATED_KEYS) && connection_.getVRM() >= JDUtilities.vrm550)   //@GKA 
                    {                                                                                                       //@GKA
                    ...
                    if(autoGeneratedKeys_ == RETURN_GENERATED_KEYS &&    //@G4A
                       (connection_.getVRM() >= JDUtilities.vrm520) && ((connection_.getVRM() < JDUtilities.vrm550) || !sqlStatement.isSelectFromInsert()))    //@F5A @F6C @GKC
                    ...
                    if(openNeeded)
                    {
                        ...
                        if((autoGeneratedKeys_ == RETURN_GENERATED_KEYS) && (connection_.getVRM() >= JDUtilities.vrm550) && sqlStatement.isSelectFromInsert())    //@GKA
                        {
        ...
        if(nameOverride_.length() == 0)
        {
            ...
            {    // @E7C
                ...
                try
                {
                    ...
                    // Note:  This should not happen if V5R5 or greater as the insert will always be wrapped with a SELECT //@GKA
  ...
  **/
    ...
    throws SQLException
    {
        ...
        if((connection_.getVRM() >= JDUtilities.vrm550) && //@GKA
