...
<p>It is possible to run multiple statements from the same connection in
different threads, but accessing a single statement from different threads
...
**/
        ...
        throws SQLException
    {
		...
		cursor_ = new JDCursor (connection_, id_, cursorDefaultName_);
...
//
      ...
      throws SQLException
    {
    	...
    	DBSQLResultSetDS request2 = new DBSQLResultSetDS (
	        ...
	        id_, DBBaseRequestDS.ORS_BITMAP_RETURN_DATA, 0);
        connection_.sendAndReceive (request2, id_);
	    	...
	    	try {
                ...
                if (openNeeded) {
                    ...
                    resultSet_ = new AS400JDBCResultSet (this,
                        ...
                        resultSetConcurrency_, fetchDirection_,
                        fetchSize_);
...
**/
                           ...
                           int rowLength) // private protected
    {
        ...
        if ((resultSetConcurrency_ != ResultSet.CONCUR_UPDATABLE)               // @B2C
            && (lastPrepareContainsLocator_ == false)) {                        // @B2A
      ...
      throws SQLException
    {
		...
		if (--numberOfResults_ > 0) {
	    	...
	    	try {
        		...
        		request.setOpenAttributes (cursor_.getOpenAttributes (null, blockCriteria_));
...
//
      ...
      throws SQLException
    {
        ...
        if (cursorName.length() > MAX_CURSOR_NAME_LENGTH)
