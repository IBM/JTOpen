 ...
 * and program parameters.  The program then runs on the IBM i system's
 ...
 * From client to IBM i, and from IBM i system to client.
 *
 * <P>
...
public class JavaApplicationCall implements Serializable
{
    ...
    **/
     ...
     * and standard error between the client and the IBM i system.  Three
    ...
    **/
    private void getFreePort()
    {
        ...
        if (read_ == null || write_ == null || error_ == null)
        {
            ...
            throw new RuntimeException("Setup connection with IBM i system failed");
        }
    }
