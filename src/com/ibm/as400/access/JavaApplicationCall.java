 ...
 * applications on the i5/OS system's Java Virtual Machine from a client.
 * The client Java program specifies the environment, program to run
 * and program parameters.  The program then runs on the i5/OS system's
 ...
 * interface of the i5/OS system's Java program on the client.  Other Java
 ...
 *
 *           // Set the classpath environment variable used by the i5/OS system's
 ...
 *           // until the i5/OS system Java program completes.  If the Toolbox
 ...
 *    }
 *
 *    // This thread will get standard out from the i5/OS system Java
...
public class JavaApplicationCall implements Serializable
{
    ...
    **/
    ...
    /**
      *Returns the list of i5/OS system messages generated if the Java program
    ...
    /**
     * Returns the optimization level of i5/OS system Java programs that
     ...
     * </UL>
     * @return     The optimization level of the i5/OS system Java application.
    **/
    ...
    **/
    ...
    /**
     * Returns the properties set on the i5/OS system's JVM before running
     * the Java program.
     *
    ...
    **/
    ...
    /**
       Sets the optimization level of the i5/OS system Java program that
       will be created if no Java program is associated with the Java
       ...
       *INTERPRET Java programs are smaller but run slower than
       ...
       @param opt  The optimization level of the i5/OS system Java program that
