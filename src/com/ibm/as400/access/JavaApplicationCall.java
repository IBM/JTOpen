 ...
 * applications on the iSeries system's Java Virtual Machine from a client.
 * The client Java program specifies the environment, program to run
 * and program parameters.  The program then runs on the iSeries system's
 ...
 * interface of the iSeries system's Java program on the client.  Other Java
 ...
 *
 *           // Set the classpath environment variable used by the iSeries system's
 ...
 *           // until the iSeries system Java program completes.  If the Toolbox
 ...
 *    }
 *
 *    // This thread will get standard out from the iSeries system Java
...
public class JavaApplicationCall implements Serializable
{
  private static final String copyright = "Copyright (C) 1997-2003 International Business Machines Corporation and others.";
    ...
    **/
     ...
     * is on iSeries server <i>system</i>.
     *
    ...
    **/
     ...
     *      iSeries system's default value of CLASSPATH is used.
    ...
    **/
    private void getFreePort()
    {
        ...
        if (read_ == null || write_ == null || error_ == null)
        {
            ...
            throw new RuntimeException("Setup connection with iSeries server failed");
        }
    }

    /**
     * Returns the relative frequency that garbage collection runs.  This
     * value applies only to V4R2 and V4R3 versions of the iSeries server.  It is
     * ignored in V4R4 and later versions of the iSeries server.
     *
    ...
    **/
    ...
    /**
      *Returns the list of iSeries system messages generated if the Java program
    ...
    /**
     * Returns the optimization level of iSeries system Java programs that
     ...
     * </UL>
     * @return     The optimization level of the iSeries system Java application.
    **/
    ...
    **/
    ...
    /**
     * Returns the properties set on the iSeries system's JVM before running
     * the Java program.
     *
    ...
    **/
    ...
    /**
       ...
       of the iSeries server.  It is ignored for V4R4 and later versions
    ...
    **/
    ...
    /**
       ...
       of the iSeries server.  It is ignore for V4R4 and later versions
       of the iSeries server.
    ...
    **/
    ...
    /**
       Sets the optimization level of the iSeries system Java program that
       will be created if no Java program is associated with the Java
       ...
       *INTERPRET Java programs are smaller but run slower than
       ...
       @param opt  The optimization level of the iSeries system Java program that
