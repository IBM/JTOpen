...
/**
 * A ReaderInputStream represents a Toolbox converter that uses
 * stateful character conversion to convert characters into bytes.
 * That is, it wraps an underlying Reader and reads/caches the
 * appropriate number of characters to return the requested
 * number of bytes.  This is especially useful for mixed byte
 * tables where the number of converted bytes is almost never the
 * same as the number of underlying Unicode characters. This class
 * exists primarily for use with JDBC CLOBs, but other components
 * are free to use it as well.
 * <p>
 * For example, the following code shows two methods that perform essentially
 * the same conversion, except one uses character converters that are part of
 * the Java runtime, and the other uses character converters that are part
 * of the Toolbox:
 * <pre>
...
public class ReaderInputStream extends InputStream
{
  ...
  private int type_ = BidiStringType.DEFAULT;
  ...
  /**
   * Constructs a ReaderInputStream that will convert Unicode characters into bytes
  ...
  **/
  ...
  /**
   * Constructs a ReaderInputStream that will convert Unicode characters into bytes
   * of the specified CCSID and bi-directional string type.
   * @param reader The Reader from which to read characters.
   * @param ccsid The CCSID used to convert characters into bytes.
  ...
  **/
   ...
   * @param ccsid The CCSID used to convert characters into bytes.
   * @param bidiStringType The {@link com.ibm.as400.access.BidiStringType bi-directional string type}.
   * @param cacheSize The number of characters to store in the internal buffer. The default is 1024.
  ...
  **/
  ...
  /**
   * Closes this ReaderInputStream and its underlying Reader. Calling close() multiple times
  ...
  **/
   ...
   * This number represents the number of characters that may be read out of the 
   * underlying Reader any time a read() method is called on this ReaderInputStream.
  ...
  **/
  ...
  /**
   * Returns the encoding used by this ReaderInputStream. If the
   * CCSID is not known, the encoding provided on the constructor
   * is returned. Otherwise, the corresponding encoding for the CCSID
   * is returned, which may be null if no such mapping exists.
  ...
  **/
  ...
  /**
   * Reads a single byte. If close() is called prior to calling this method,
  ...
  **/
  ...
  /**
   * Reads bytes into a portion of the specified array. If close() is called prior to calling
   * this method, an exception will be thrown.
   * @param buffer The destination buffer.
  ...
  **/
  ...
  /**
   * Skips the specified number of bytes. If close() is called prior to calling this
