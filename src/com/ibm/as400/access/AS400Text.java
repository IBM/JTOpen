...
public class AS400Text implements AS400DataType
{
    ...
    AS400Text(int length, int ccsid, AS400Impl system)
    {
        ...
        length_ = length;
        ccsid_ = ccsid;
        // Notice that we have not filled in the Converter object.  We can't do that because we don't know if this object will in the end be used on the public side (Converter) or on the server side (ConverterImpl).
