...
class UserSpaceImplNative extends UserSpaceImplRemote
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // $B2 - This method is now implemented in UserSpace.class
    // ----------------------------------------------------------------------
    // Close a user space                         (called from userSpaceImpl)
    //
    // ----------------------------------------------------------------------
    //void close()                                // $B1
    //   throws IOException
    ...
    public void close() throws IOException
   {
    ...
    int getAttributes(int valueToReturn)
      throws AS400SecurityException,
    ErrorCompletingRequestException,
    InterruptedException,
    IOException,
    ...
    {
        return ((byte) getAttributes(INITIAL_VALUE));
    }
    ...
    ObjectDoesNotExistException
    {
        ...
        if (getAttributes(AUTO_EXTENDIBLE) == 0x000000F0)
            return false;
        else
            return true;
    ...
    // ----------------------------------------------------------------------
    //
    // Create a  user space                       (called from UserSpaceImpl)
    //
    // ----------------------------------------------------------------------
    ...
    void setAttributes(int valueToSet, int newValue)
    ...
    ObjectDoesNotExistException
    {
        ...
        if (newValue)
            setAttributes(AUTO_EXTENDIBLE, 1);
        else
            setAttributes(AUTO_EXTENDIBLE, 0);
    }
    ...
    ObjectDoesNotExistException
    {
        setAttributes(INITIAL_VALUE, initialValue);
    }
...

    {
        ...
        if (actualLength == 0)
        {
            int userSpaceLength = getAttributes(LENGTH);
    ...
    int readData(byte dataBuffer[], int userSpaceOffset, int dataOffset, int length)
    ...
    void buildException(NativeException e, int source)
