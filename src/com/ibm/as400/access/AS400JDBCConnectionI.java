...
/**
<p>The AS400JDBCConnectionI interface provides an interface
used by all JDBC connection objects in JTOpen. 
**/
public 
interface AS400JDBCConnectionI
extends Connection
{
...
void handleAbort();
    ...
    **/
    int correctResultSetType (int resultSetType,
    ...
    **/
    void debug (DBBaseRequestDS request);
    ...
    **/
    void debug (DBReplyRequestedDS reply);
    ...
    **/
    ...
    //
    int getUnusedId (int resultSetType) //@P0C
    throws SQLException;
    ...
    **/
    ...
    // @E10 new method
    Savepoint setSavepoint(String name, int id)
    throws SQLException;
...
//@L9A
  ...
  void setLastServerSQLState(String lastSqlState);
