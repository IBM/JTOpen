...
**/
  IFSCopyReq(String sourcePath, String destinationPath, boolean replace)
  {
    ...
    setReqRepID(0x0001);
    set16bit(13488, SOURCE_CCSID_OFFSET); // We always use UCS-2; this could be
    set16bit(13488, TARGET_CCSID_OFFSET); // upgraded to UTF-16 when the server supports it.
    ...
    // Bits 3,2 = deep copy,shallow copy
    //  11 = not allowed
...
//    offset = SOURCE_NAME_LL_OFFSET+6+(sourcePath.length()*2);
