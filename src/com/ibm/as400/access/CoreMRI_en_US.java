...
//
//
// We extend CoreMRI rather than CoreMRI_en to circumvent the loading
// of the CoreMRI_en class, which does not contain anything, anyway.
//
public class CoreMRI_en_US extends CoreMRI
{
