...
public class JavaProgram implements Serializable
{
    ...
    **/
           ...
           UnsupportedEncodingException
    {
        ...
        parms[10] = new ProgramParameter(0);                                    //classpath used reciever variable
        parms[11] = new ProgramParameter(BinaryConverter.intToByteArray(0));    //length of classpath used reciever variable
