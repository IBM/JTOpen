...
public class HTMLApplet extends HTMLTagAttributes implements java.io.Serializable       // @Z1C
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
   ...
   {
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "Adding HTMLParameter to applet.");
   ...
   {
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "Generating HTMLApplet tag...");
   ...
   public void removeParameter(HTMLParameter param)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "Removing HTMLParameter from the applet.");
   ...
   public void setCodebase(String codebase)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "   Setting Applet codebase.");
   ...
   public void setArchive(String archive)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "   Setting Applet archive.");
   ...
   public void setCode(String code)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "   Setting Applet code.");
   ...
   public void setHeight(int height)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "   Setting Applet height.");
   ...
   public void setText(String text)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "   Setting Applet alternate text.");
   ...
   public void setWidth(int width)
   {
      ...
      if ( Trace.isTraceOn() )
         Trace.log(Trace.INFORMATION, "   Setting Applet width.");
