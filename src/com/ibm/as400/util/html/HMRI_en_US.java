...
//
// We extend HMRI rather than HMRI_en to circumvent the loading
// of the HMRI_en class, which does not contain anything, anyway.
//
public class HMRI_en_US extends HMRI
{
