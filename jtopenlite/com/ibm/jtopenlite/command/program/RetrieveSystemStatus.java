...
**/
public class RetrieveSystemStatus extends ProgramAdapter
{
  ...
  {
    return poolSelectionTypeOfPool_ == null ? super.getNumberOfParametersSubclass() : 7;
  }
  ...
  **/
  ...
  private int readBasicPoolInfo(final byte[] data, int numRead, final char[] c)
  {
    ...
    int poolSize = Conv.byteArrayToInt(data, numRead); numRead += 4;
    int reservedSize = Conv.byteArrayToInt(data, numRead); numRead += 4;
